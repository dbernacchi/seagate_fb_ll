...
$(document).ready(function() {
	...
	//enable and disable validation pop up message
	...
	if (document.newsFeedForm != undefined && document.newsFeedForm.twitterID != undefined) {
	    getTwitterFeed(document.newsFeedForm.twitterID.value,"twitterFeed", ".newsFaderList > li");
	} else {
		$("#twitterFeed").remove();
...
$(document).ready(function() {
	if($("#dynamicDistDataId")[0]){
		showDistributor();
	}
	
	if($("#eventCalenderBoxId")[0]){
		showEventCalendar();
	}
...
$(window).load(function (){
	if(!$("#cb-spp-overview-techinsight .jspVerticalBar")[0]){
		$(".partnersTabBox .eventsList .largeImgHold img").css({"width" : "316px", "height" : "120px"});
	}
});