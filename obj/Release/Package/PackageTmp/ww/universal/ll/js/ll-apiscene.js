...
, ComputeCubeAttributes: function( cubeIndex, partOffsetDir, partScale, partColorAndIndex, doRotate )
{
    //
    // COLORS
    //
...
, UpdateGeometry: function( cubeCount )
{
    ...
    for( var ci=0; ci<cubeCount; ci++ )
    {
        ...
        this.ComputeCubeAttributes( ci, partOffsetDir, partScale, partColorAndIndex, doRotate );
...
, UpdateRibbonGeometry: function( cubeCount )
{
    ...
    for( var ci=0; ci<cubeCount; ci++ )
    {
        ...
        // Compute values for custom attributes. Returns into parameters
        this.ComputeCubeAttributes( ci, partOffsetDir, partScale, partColorAndIndex, 0.0 );
