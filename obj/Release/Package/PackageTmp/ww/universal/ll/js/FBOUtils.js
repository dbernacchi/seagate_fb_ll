...
THREE.FBOUtils = function( textureWidth, textureHeight, renderer, simulationShader )
{
	...
	var cameraRTT = new THREE.OrthographicCamera(-textureWidth/2, textureWidth/2, textureHeight/2, -textureHeight/2, -1000000, 1000000);

	cameraRTT.position.z = 100;


	var rtTexturePos = new THREE.WebGLRenderTarget(textureWidth, textureHeight, {
	...
	this.quad = new THREE.Mesh(plane, simulationShader);
	this.quad.position.z = -5000;
	sceneRTTPos.add( this.quad );
...
{
	var texture = THREE.FBOUtils.createTextureFromData( this.textureWidth, this.textureHeight, data );
...
THREE.FBOUtils.prototype.SetSimulationShader = function( mat_ )
{
    this.quad.material = mat_;
}
